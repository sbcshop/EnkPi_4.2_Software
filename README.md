...
<img src= "https://github.com/sbcshop/EnkPi_4.2_Software/blob/main/images/pinout_4_2.jpg" />

### Pinouts:

1.	6 User buttons
2.	4.2” E-Paper Display
3.	Raspberry Pi Pico W
4.	Type C
5.	Buzzer
6.	Micro SD card slot
7.	JST 2mm Female 1x8 Pin 
8.	FPC connector for E-paper
9.	Coin Holder CR1220 for RTC 
...
### Example Codes
   ...
   - [Example 3](https://github.com/sbcshop/EnkPi_4.2_Software/blob/main/examples/display_shapes.py) : Play with some shapes like circle, square, etc.
   - [Example 4](https://github.com/sbcshop/EnkPi_4.2_Software/blob/main/examples/display_images.py) : To display images on EnkPi, this code need library EnkPi_4in2.py & pics.py and to follow this example you have to go through [Step by Step Guide to build byte array from Image](https://github.com/sbcshop/EnkPi_2.9_Software/blob/main/Downloads/Step%20by%20Step%20Guide%20to%20create%20byte%20array%20from%20image.pdf)
   - and [More...](https://github.com/sbcshop/EnkPi_4.2_Software/tree/main/examples)
   
   Now you are ready to try out your own codes, **_Happy Coding!_**

## Documentation
  * [EnkPi 4.2" Schematic](https://github.com/sbcshop/EnkPi_4.2_Hardware/blob/main/Design%20Data/SCH%20EnkPi%204.2%20INCH.pdf)
  * [EnkPi 4.2" Hardware](https://github.com/sbcshop/EnkPi_4.2_Hardware)
  * [EnkPi 4.2" StepFile](https://github.com/sbcshop/EnkPi_4.2_Hardware/blob/main/Mechanical%20Data/EnkPi_4_2_step.zip)
